...
var (
	...
	NATIVE_ASSET_NAME           = "MAGMA"
	NATIVE_ASSET_TICKER         = "MAGMA"
	NATIVE_ASSET_IDENTIFICATION = "MAGMA"
	NATIVE_ASSET_DESCRIPTION    = "MAGMA is the native coin on MoltenChain."
